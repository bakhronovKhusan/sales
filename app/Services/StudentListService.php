...
class StudentListService
{
    public function list(Request $request)
    {
        ...
        $result =  DB::select('SELECT
                                        ...
                                        END AS status_type,
                                        CONCAT("api/v1/hunter/activate/",t_group_student.group_id,"/",t_group_student.student_id) as check_url,
                                        CONCAT("api/v1/hunter/de-activate/",t_group_student.group_id,"/",t_group_student.student_id) as de_activate_check_url,
                                        CONCAT(
                                            CONCAT("W",
